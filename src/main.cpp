...
int main()
{
    ...
    string filepath1 = "E:\\mayur\\src\\sphere.stl";
    string filepath2 = "E:\\mayur\\src\\cube1.stl";
    string filepathmodifer1 ;
    string filepathmodifer2 ;
    obj.readFromFile("E:\\mayur\\src\\cube1.stl");
    vec1Copy = obj.boundryPoints(filepath1);
    
    // obj.readFromFile("E:\\mayur\\src\\bottol.stl");
    ...
    double value1 =0;
    double value2 = 0;
    // if(vec1.at(1)<vec2.at(0))
    // {
    //     value = vec2.at(0) - vec1.at(0);
    //     value1 = vec2.at(2) - vec1.at(3);
    //     value2 = vec2.at(4) - vec1.at(4);
    // }else
    // {
        if(choice==1)
        {
